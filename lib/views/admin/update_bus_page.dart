...
class UpdateBusPage extends StatefulWidget {
  Bus bus;
  UpdateBusPage({super.key, required this.bus});

  @override
  State<UpdateBusPage> createState() => _AddBusPageState();
}

class _AddBusPageState extends State<UpdateBusPage> {
  ...
  @override
  void initState() {
    idController.text = widget.bus.id;
    descriptionController.text = widget.bus.description;
    energyController.text = widget.bus.energy;
    feeController.text = widget.bus.fee.toString();
    busType = widget.bus.type;
    driver = widget.bus.driver_id;
          ...
          child: Form(
              ...
              child: Column(
                children: [
                  ...
                  images.isEmpty && widget.bus.images!.isEmpty
                      ? Container(
                          width: MediaQuery.of(context).size.width,
                          height: 150,
                              ...
                              child: Center(
                                child: GestureDetector(
                                    ...
                                    child: GridView.builder(
                                        ...
                                        itemCount: widget.bus.images!.length,
                                        gridDelegate:
